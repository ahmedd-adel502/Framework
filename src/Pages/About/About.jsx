  ...
  return (
   <div className={`mt-[6rem] text-center min-h-[calc(95vh-64px)] bg-maingreen flex justify-center items-center flex-col ${theme}`}>
          <div className="container mx-auto">
            ...
            <div className="text-white flex justify-center flex-col sm:flex-row gap-4">
                <p className="sm:w-[40%] w-[80%] mx-auto px-4 text-left">Freelancer is a free bootstrap theme created by Route. The download includes the complete source files including HTML, CSS, and JavaScript as well as optional SASS stylesheets for easy customization.</p>
                <p className="sm:w-[40%] w-[80%] mx-auto px-4 text-left">Freelancer is a free bootstrap theme created by Route. The download includes the complete source files including HTML, CSS, and JavaScript as well as optional SASS stylesheets for easy customization.</p>
            </div>
          </div>
